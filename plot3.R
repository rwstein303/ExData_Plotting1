## This script will produce a line plot of three Sub_metering values from the data
...
png(file="plot3.png")
par(pch=".")
with(PlotData, plot(DateTime, Sub_metering_1, xlab="", ylab="Energy sub metering", type="n"))
